...
class MySpider(scrapy.Spider):
    ...
    base_url = "http://losangeles.craigslist.org/search/see/apa?"
    start_urls = ["http://losangeles.craigslist.org/search/see/apa?"]
...
#        df = pd.DataFrame(columns = list(test.keys()), index=xrange(0,2400))
    ...
    def parse(self, response):
        ...
        for i in range(0, len(postings)-1):
            ...
            print item["link"]
            follow = "http://losangeles.craigslist.org" + item["link"]
